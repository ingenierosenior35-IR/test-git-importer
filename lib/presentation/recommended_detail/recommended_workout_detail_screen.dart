...
class RecommendedDetailScreen extends StatefulWidget {
  const RecommendedDetailScreen({super.key});
                    ...
                    children: [
                      Stack(
                        children: [
                          Container(
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                    image: AssetImage(recommendedWorkoutController
                          ...
                          recommendedWorkoutController.currentWorkout!.isPro!
                              ? CustomIconButton(
                            height: getSize(24),
                            width: getSize(24),
                            margin: getMargin(
